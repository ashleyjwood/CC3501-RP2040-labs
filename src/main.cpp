...
int main()
{
    ...
    for (;;)
    {
        ...
        // led.update_multiple_leds(0, CYAN);
        // // led.update_multiple_leds(3, MAGENTA, 4, MAGENTA, 5, MAGENTA);
        // // led.update_multiple_leds(6, YELLOW, 7, YELLOW, 8, YELLOW);
        // // led.update_multiple_leds(9, PURPLE, 10, PURPLE, 11, PURPLE);
        // led.update_led();
        // sleep_ms(100);
        ...
        // led.update_multiple_leds(0, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(1, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(2, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(3, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(4, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(5, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(6, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(7, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(8, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(9, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(10, RED);
        // busy_wait_ms(100);
        // led.update_multiple_leds(11, RED);
        // busy_wait_ms(100);
        // led.turn_led_off_all();
        // busy_wait_ms(100);
